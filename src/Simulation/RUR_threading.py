...
class commande_thread (threading.Thread):
   def __init__(self, commande, name):
   ...
   def run(self):
      ...
      threadLock.acquire()
      self.commande = input("Entrez une commande : ")
      sleep(0.01)
...
if __name__ == "__main__":
   ...
   # Create new threads
   thread1 = commande_thread("rest", "commande RUR")
